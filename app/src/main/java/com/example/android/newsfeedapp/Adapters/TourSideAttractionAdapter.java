...
public class TourSideAttractionAdapter extends ArrayAdapter<PlaceData> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView typeOfSideAttraction_text_view = (TextView) tourAttractionListView.findViewById(R.id.titleOfStory_text_view);
        typeOfSideAttraction_text_view.setText(currentTourAttraction.getTitleOfStory());

        // Find the ImageView in the place_detailed_information_item.xml layout with the ID imageOfPlace_image_view
        ImageView typeOfSideAttraction_img = (ImageView) tourAttractionListView.findViewById(R.id.imageOfStory_image_view);
        typeOfSideAttraction_img.setImageResource(currentTourAttraction.getImageOfStoryResourceID());
