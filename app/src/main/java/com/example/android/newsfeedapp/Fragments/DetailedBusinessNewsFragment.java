...
public class DetailedBusinessNewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView news_title_text_view = (TextView) rootView.findViewById(R.id.titleOfStory_text_view);

        // Updates image of news story
        ImageView news_image_view = (ImageView) rootView.findViewById(R.id.imageOfStory_image_view);

        // Updates section of news story
        TextView sectionView = (TextView) rootView.findViewById(R.id.section);

        // Updates author of news story
        TextView authorView = (TextView) rootView.findViewById(R.id.authorName);
